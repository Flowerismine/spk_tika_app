...
const EditKriteriaDefisit = () => {
  ...
  const getKriteriaDefisitById = async () => {
    try {
      const token = localStorage.getItem("token");
      const apiUrl = `${API_URL}`;
      const response = await axios.get(`${apiUrl}/kriteria-defisit/${id}`, {
        headers: {
  ...
  const updateKriteriaDefisit = async (e) => {
    e.preventDefault();
    ...
    try {
      const token = localStorage.getItem("token");
      const apiUrl = `${API_URL}`;
      await axios.patch(`${apiUrl}/kriteria-defisit/${id}`, jsonData, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
      });
      navigate("/kriteria-pasien");
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="relative z-10 pt-20 sm:pt-24 md:pt-6 px-4 sm:px-6 pb-6">
        <div className="max-w-7xl mx-auto">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-white">
                      Edit Kriteria Defisit Kalori
                    </h1>
                  </div>
                  <p className="text-white/70 ml-12">
                    Edit kriteria untuk klasifikasi pasien yang membutuhkan
                    pengurangan kalori
                  </p>
                </div>
              </div>
          ...
          {/* Form */}
          <form onSubmit={updateKriteriaDefisit}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-white/60 text-sm mt-2">
                      Contoh: "Jenis Kelamin, Aktivitas, IMT, Main", dll.
                    </p>
                  </div>
...
export default EditKriteriaDefisit;
