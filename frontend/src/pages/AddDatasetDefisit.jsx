...
const AddDatasetDefisit = () => {
  ...
  const saveDataset = async (e) => {
    ...
    try {
      ...
      alert(error.response?.data?.msg || "Terjadi kesalahan saat menyimpan dataset");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 shadow-2xl rounded-2xl p-8 max-w-md text-center">
          ...
          <p className="text-white/70 mb-6">
            Anda perlu menambahkan kriteria defisit terlebih dahulu sebelum membuat dataset.
          </p>
          <button
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-white">
                      Tambah Dataset Defisit Kalori
                    </h1>
                  </div>
                  <p className="text-white/70 ml-12">
                    Tambahkan data baru untuk pasien yang membutuhkan pengurangan kalori
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="p-8">
                <div className="space-y-6">
                  ...
                  {(() => {
                    ...
                    return kriteriaDefisit.map((kriteria) => {
...
export default AddDatasetDefisit;