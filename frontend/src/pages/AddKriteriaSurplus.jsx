...
const AddKriteriaSurplus = () => {
  ...
  const saveKriteria = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.post(`${API_URL}/kriteria-surplus`, jsonData, {
        headers: {
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-white">
                      Tambah Kriteria Surplus Kalori
                    </h1>
                  </div>
                  <p className="text-white/70 ml-12">
                    Tambahkan kriteria baru untuk klasifikasi pasien yang
                    membutuhkan penambahan kalori
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <input
                        ...
                        placeholder="Masukkan nama kriteria surplus kalori..."
                      />
...
export default AddKriteriaSurplus;
