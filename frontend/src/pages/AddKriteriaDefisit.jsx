...
const AddKriteriaDefisit = () => {
  ...
  const saveKriteria = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.post(`${API_URL}/kriteria-defisit`, jsonData, {
        headers: {
...
export default AddKriteriaDefisit;
