...
const AddKriteriaMakanan = () => {
  ...
  const saveKriteria = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.post(`${API_URL}/kriteria-makanan`, jsonData, {
        headers: {
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl font-bold text-white">
                      Tambah Kriteria Makanan
                    </h1>
                  </div>
                  <p className="text-white/70 ml-12">
                    Tambahkan kriteria baru untuk klasifikasi makanan yang boleh dan tidak boleh
                  </p>
                </div>
              </div>
            </div>
...
export default AddKriteriaMakanan;
